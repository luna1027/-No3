...
?>
<div class="tab rb" style="width:95%;">
  <div style="background:#FFF; width:100%; color:#333; text-align:left">
    <video src="./upload/<?= $row['trailer']; ?>" width="300px" height="250px" controls="" style="float:right;"></video>
    <font style="font-size:24px">
      <img src="./upload/<?= $row['poster']; ?>" width="200px" height="250px" style="margin:10px; float:left">
      ...
      <p style="margin:3px">影片分級 ： <img src="./icons/03C0<?= $row['level']; ?>.png" style="display:inline-block;"><?= $Movie->level[$row['level']]; ?></p>
      <p style="margin:3px">影片片長 ： <?= $row['length']; ?>分</p>
      <p style="margin:3px">上映日期 <?= $row['ondate']; ?></p>
      <p style="margin:3px">發行商 ： <?= $row['publish']; ?></p>
      <p style="margin:3px">導演 ： <?= $row['directior']; ?></p>
      <br>
      <br>
